	...
	<view>
		...
		<view :class="{
		  ...
		  'uni-fab__content--other-platform': !isAndroidNvue
			...
			<view v-if="!title" class="fab-circle-v" :class="{'uni-fab__plus--active': isShow}"></view>
			<view v-if="!title" class="fab-circle-h" :class="{'uni-fab__plus--active': isShow}"></view>
			<text class="tit" v-if="title">{{title}}</text>
		</view>
	</view>
</template>
